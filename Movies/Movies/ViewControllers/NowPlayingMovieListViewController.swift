...
class NowPlayingMovieListViewController: ListViewController {
    private let viewModel: ViewModel<Movie, MovieListReponse>

    init(navigationTitle: String, viewModel: ViewModel<Movie, MovieListReponse>) {
        self.viewModel = viewModel
        super.init(navigationTitle: navigationTitle)
        setupViewModel()
        setupCollectionView()
    }
